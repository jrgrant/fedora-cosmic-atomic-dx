#!/bin/bash
# brew-install.sh — Vendored Homebrew installer (HEAD as of 2026-08-02)
#
# This is a verbatim copy of Homebrew's install.sh fetched from:
#   https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh
#
# It is vendored to eliminate the supply-chain risk of curl|bash from
# a mutable URL at boot time. See brew-setup for the invocation context.
#
# To update: curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh \
#   -o system_files/shared/usr/libexec/ublue-os/brew-install.sh
#
# Do NOT modify — keep verbatim for clean re-vendoring.
